...
optimizer = t.optim.Adam(model.parameters(),lr=1e-5, weight_decay=0.005)
early_stop = EarlyStoppingCallback(5)

trainer_obj = Trainer(model, criterion, optimizer, train_dl, val_dl, cuda=True, early_stopping_cb=early_stop)
# go, go, go... call fit on trainer
res = trainer_obj.fit(10)
print(res)
